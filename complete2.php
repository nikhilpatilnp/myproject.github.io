     ...
     <li class="profile">
      <div class="profile-details">
        ...
        <div class="name">Writer</div>
         ...
         <a href="opton.php" > <i class='bx bx-log-out' id="log_out" ></i><a>
     </li>
    </ul>
  </div>
  <!--<CONTAINER>-->
...
if (isset($_GET["id"])) {
    ...
    <button type="submit" onclick="setTimeout(function(){ alert('Article deleted successfully!'); }, 500);">Delete</button>
</form>
